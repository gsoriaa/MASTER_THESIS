...
## Se consulta la web immgen y los datos de expresión de
## Maria Casanova et al., 2021.

# Se describe en el script 4.2
...
pdf("FIGURA_11C-receptor_expresion_dotplot.pdf")
rotated_dotplot
dev.off()

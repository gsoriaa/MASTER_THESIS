...
cellphonedb method degs_analysis meta.tsv counts_mtx/ human-cellphone_genes-EMTp_x_AM.txt --counts-data hgnc_symbol --output-path out_simple
...
##
## 12 interacciones identificadas con el método clásico
